...
@section('title')
    Search Results | UKM Trading & Service System
@endsection
            ...
            @forelse($products as $product)
                <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            @if ($product->status == "Available") <h6 class="text-success float-right">{{$product->status}}</h6>
                            @elseif ($product->status == "Pending") <h6 class="text-warning float-right">{{$product->status}}</h6>
                            @else <h6 class="text-danger float-right">{{$product->status}}</h6>
                            @endif
